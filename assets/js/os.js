  ...
  if (document.getElementById("SJF").checked) {
    ...
    while (!(queue.length == 0)) {
      ...
      if (index == -1) {
        ...
        table.rows[1 + r].cells[4].innerHTML =
          Number(time) - Number(table.rows[1 + r].cells[1].innerHTML);
    ...
    while (!(queue.length == 0)) {
      ...
      if (bt[0] <= tq) {
        ...
        if (table.rows[1 + i].cells[4].innerHTML == "") {
          table.rows[1 + i].cells[4].innerHTML =
            Number(time) - Number(table.rows[1 + i].cells[1].innerHTML);
          table.rows[1 + i].cells[6].innerHTML = time + temp2;
          table.rows[1 + i].cells[5].innerHTML =
            Number(table.rows[1 + i].cells[6].innerHTML) -
            Number(table.rows[1 + i].cells[1].innerHTML);
          table.rows[1 + i].cells[7].innerHTML =
            Number(table.rows[1 + i].cells[5].innerHTML) -
            Number(table.rows[1 + i].cells[2].innerHTML);
        } else {
          table.rows[1 + i].cells[6].innerHTML = time + temp2;
          table.rows[1 + i].cells[5].innerHTML =
            Number(table.rows[1 + i].cells[6].innerHTML) -
    ...
    while (!(queue.length == 0)) {
      ...
      if (bt[i] > 0) {
        if (bt[i] == Number(table.rows[2 + i].cells[2].innerHTML)) {
          table.rows[2 + i].cells[4].innerHTML =
            "" + (time - Number(table.rows[2 + i].cells[1].innerHTML));
        }
        ++time;
      ...
      for (i = 0; i < processes; ++i) {
        table.rows[2 + i].cells[5].innerHTML =
          Number(table.rows[2 + i].cells[6].innerHTML) -
          Number(table.rows[2 + i].cells[1].innerHTML);
        table.rows[2 + i].cells[7].innerHTML =
          Number(table.rows[2 + i].cells[5].innerHTML) -
          Number(table.rows[2 + i].cells[2].innerHTML);
      }
    }
    calAverage(processes);
    create_Graph();
  ...
  //Priority
    ...
    while (queue.length != 0) {
      ...
      if (f == 0) {
        ...
        table.rows[1 + index].cells[5].innerHTML =
          Number(table.rows[1 + index].cells[6].innerHTML) -
          Number(table.rows[1 + index].cells[1].innerHTML);
        table.rows[1 + index].cells[7].innerHTML =
          Number(table.rows[1 + index].cells[5].innerHTML) -
          Number(table.rows[1 + index].cells[2].innerHTML);
        addprocessesPrio(time, processes, queue, check_pro, bt, pl);
      }
